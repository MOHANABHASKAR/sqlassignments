...
insert into cus_Information values('mohan',23,439439292312)
insert into cus_Information values('bhaskar',24,129439292123)
insert into cus_Information values('rajesh',20,3494392928909)
insert into cus_Information values('akash',25,679439292657)
insert into cus_Information values('bhanu',23,899439292234)
